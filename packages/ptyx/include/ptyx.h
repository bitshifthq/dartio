...
typedef uint32_t ptyx_error_domain_t;
/** Stable error-kind value. */
typedef uint32_t ptyx_error_kind_t;
/** Stable operation identifier. */
typedef uint32_t ptyx_operation_t;
/** Stable event-kind value. */
typedef uint32_t ptyx_event_kind_t;
...
/** No error domain. */
#define PTYX_ERROR_DOMAIN_NONE UINT32_C(0)
/** Caller input validation failure. */
#define PTYX_ERROR_DOMAIN_ARGUMENT UINT32_C(1)
/** Lifecycle or handle-state failure. */
#define PTYX_ERROR_DOMAIN_STATE UINT32_C(2)
/** Terminal input direction failure. */
#define PTYX_ERROR_DOMAIN_INPUT UINT32_C(3)
/** Terminal output direction failure. */
#define PTYX_ERROR_DOMAIN_OUTPUT UINT32_C(4)
/** Child process operation failure. */
#define PTYX_ERROR_DOMAIN_PROCESS UINT32_C(5)
/** Shared runtime infrastructure failure. */
#define PTYX_ERROR_DOMAIN_RUNTIME UINT32_C(6)
/** Operating-system boundary failure. */
#define PTYX_ERROR_DOMAIN_OS UINT32_C(7)

/** No error kind. */
#define PTYX_ERROR_NONE UINT32_C(0)
/** Invalid caller value or layout. */
#define PTYX_ERROR_INVALID_ARGUMENT UINT32_C(1)
/** Retired or unknown generation-checked identity. */
#define PTYX_ERROR_STALE_HANDLE UINT32_C(2)
/** Operation rejected by the current lifecycle state. */
#define PTYX_ERROR_WRONG_STATE UINT32_C(3)
/** Bounded queue cannot accept the complete operation. */
#define PTYX_ERROR_QUEUE_FULL UINT32_C(4)
/** Capability is unavailable on this backend. */
#define PTYX_ERROR_UNSUPPORTED UINT32_C(5)
/** Session or direction is terminal. */
#define PTYX_ERROR_CLOSED UINT32_C(6)
/** Native or operating-system operation failed. */
#define PTYX_ERROR_NATIVE_FAILURE UINT32_C(7)
/** Runtime ownership or event infrastructure was lost. */
#define PTYX_ERROR_INFRASTRUCTURE_LOST UINT32_C(8)

/** No associated operation. */
#define PTYX_OPERATION_NONE UINT32_C(0)
/** Runtime construction. */
#define PTYX_OPERATION_RUNTIME_CREATE UINT32_C(1)
/** Runtime shutdown or release. */
#define PTYX_OPERATION_RUNTIME_SHUTDOWN UINT32_C(2)
/** Child and terminal spawn. */
#define PTYX_OPERATION_SPAWN UINT32_C(3)
/** Terminal input write. */
#define PTYX_OPERATION_WRITE UINT32_C(4)
/** Terminal output delivery or cancellation. */
#define PTYX_OPERATION_OUTPUT UINT32_C(5)
/** Terminal resize. */
#define PTYX_OPERATION_RESIZE UINT32_C(6)
/** Child termination. */
#define PTYX_OPERATION_TERMINATE UINT32_C(7)
/** Atomic session metadata snapshot or observation. */
#define PTYX_OPERATION_METADATA UINT32_C(8)
/** Session cleanup. */
#define PTYX_OPERATION_CLOSE UINT32_C(9)
