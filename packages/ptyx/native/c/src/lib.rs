...
pub mod private {
    pub use crate::c_api::{
        ...
        SpawnOptions, ERROR_DOMAIN_ARGUMENT, ERROR_DOMAIN_RUNTIME, ERROR_DOMAIN_STATE,
        ERROR_INFRASTRUCTURE_LOST, ERROR_INVALID_ARGUMENT, ERROR_STALE_HANDLE, ERROR_WRONG_STATE,
        OPERATION_CLOSE, OPERATION_OUTPUT, OPERATION_RUNTIME_CREATE, OPERATION_RUNTIME_SHUTDOWN,
