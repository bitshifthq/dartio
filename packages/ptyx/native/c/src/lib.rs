...
pub mod private {
    pub use crate::c_api::{
        ...
        ptyx_session_release, ptyx_session_spawn_start, set_error, Error, Event, Registry,
        SpawnOptions, ERROR_DOMAIN_ARGUMENT, ERROR_DOMAIN_PROCESS, ERROR_DOMAIN_RUNTIME,
        ERROR_DOMAIN_STATE, ERROR_INFRASTRUCTURE_LOST, ERROR_INVALID_ARGUMENT,
        ERROR_NATIVE_FAILURE, ERROR_STALE_HANDLE, ERROR_WRONG_STATE, OPERATION_CLOSE,
        OPERATION_EXIT, OPERATION_OUTPUT, OPERATION_RUNTIME_CREATE, OPERATION_RUNTIME_SHUTDOWN,
        STATUS_INTERNAL, STATUS_INVALID_ARGUMENT, STATUS_OK, STATUS_STALE_HANDLE,
        STATUS_WRONG_STATE,
    };
...
#[doc(hidden)]
pub fn linked_symbols() -> [usize; 17] {
    [
        ...
        c_api::ptyx_session_snapshot as *const () as usize,
