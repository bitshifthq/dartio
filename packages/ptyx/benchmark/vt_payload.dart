...
/// filtering controls gives compact terminal-state checks an unambiguous text
/// stream without changing the package's raw PTY output contract. It does not
/// reconstruct application writes that ConPTY did not expose.
