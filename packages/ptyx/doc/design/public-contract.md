...
Native state owns cleanup independently of the Dart wrapper. Dart finalization,
native-port closure, failed message posting, and isolate loss all commit the
same idempotent native shutdown path. Late messages carry generation-checked
