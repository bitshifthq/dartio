# Contributing to DartIO

Contributions are welcome, and thank you for taking an interest in DartIO. I
want the project to be easy to improve without making it harder to understand
or maintain.
...
- **Scope.** Group each pull request around a clear purpose. Refactoring,
  ...
  easy to understand and review. Keep package boundaries intact. Each package
  must remain independently publishable, with its platform support explicit.
...
- **Testing.** Every behavior change must have appropriate test coverage.
  ...
  formatting, analysis, and all Dart and native checks relevant to the
  affected package and platforms before submitting.
...
- **Description.** Keep the pull request description concise and specific.
  ...
  not submit an unfiltered summary generated by AI or include detail that does
  not help reviewers understand the change.
